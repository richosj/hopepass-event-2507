      ...
      <div className="visual__inner">
        <div className="visual__container">
          ...
          <div className="visual__info">
            <dl>
              <dt>희망패스 미션 기간</dt>
              <dd>2025.11.06 ~ 2025.12.07</dd>
            </dl>
            <dl>
              <dt>희망패스 룰렛 참여 기간</dt>
              <dd>2025.11.06 ~ 2025.12.31</dd>
            </dl>
          </div>
          <div className="visual__thoughts">
            <span className='pc'><img src="/assets/visual/Thoughts.png" alt="" /></span>
            <span className='mobile'><img src="/assets/visual/Thoughts-mobile.png" alt="" /></span>
          </div>
        </div>
      </div>
    </div>
